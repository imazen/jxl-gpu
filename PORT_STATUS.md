...
| `quantize_block_dct8` | `quantize::quantize_block_dct8_scalar` | ❌ | — |
| `quantize_block_large` | `quantize::quantize_block_large_scalar` | ❌ | — |
| `dequant_block_dct8` | `dequant::dequant_block_dct8_scalar` | ❌ | — |
| `compute_block_l2_errors` | `block_l2::compute_block_l2_errors_scalar` | ❌ | — |
| `pixel_domain_loss` | `pixel_loss::pixel_domain_loss_scalar` | ❌ | — |
