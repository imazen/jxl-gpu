...
| Component | Status |
|---|---|
| Per-strategy whole-image cost grid kernels | ⚙ | Single-channel cost grids for DCT4x4, DCT4x8, DCT8x4, DCT8, DCT16x8, DCT8x16, DCT16x16, DCT32x16, DCT16x32, DCT32x32, DCT64x32, DCT32x64, DCT64x64 (DCT4/8/16/32/64 family — square + rect — complete). 3-channel XYB-weighted + mask1x1 cost grids for the full DCT8/16/32/64 family — 4 squares (DCT8, DCT16x16, DCT32x32, DCT64x64) + 6 rect (DCT16x8, DCT8x16, DCT32x16, DCT16x32, DCT64x32, DCT32x64) = 10 strategies (`compute_cost_grid_*_xyb`); needs CfL + DCT4 family + IDENTITY/DCT2X2/AFV variants |
