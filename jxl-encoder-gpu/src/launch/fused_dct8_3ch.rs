...
pub fn fused_dct8_3ch<R: Runtime>(
    ...
    unsafe {
        fused_dct8_3ch_kernel::launch_unchecked::<R>(
            ...
            ArrayArg::from_raw_parts(quant_dc_x, n_b),
            ArrayArg::from_raw_parts(quant_dc_y, n_b),
            ArrayArg::from_raw_parts(quant_dc_b, n_b),
            ArrayArg::from_raw_parts(float_dc_x, n_b),
            ArrayArg::from_raw_parts(float_dc_y, n_b),
            ArrayArg::from_raw_parts(float_dc_b, n_b),
            inv_dc_factor_x,
            inv_dc_factor_y,
            inv_dc_factor_b,
            plane_stride,
