...
pub fn set_llf_dct32x16_indexed<R: Runtime>(
    ...
    let cubes = n_blocks.div_ceil(TPB).max(1);
    unsafe {
        set_llf_dct32x16_indexed_kernel::launch_unchecked::<R>(
            client,
            CubeCount::Static(cubes, 1, 1),
            CubeDim::new_1d(TPB),
            ArrayArg::from_raw_parts(dc_grid, dc_grid_n),
...
#[allow(clippy::too_many_arguments)]
pub fn set_llf_dct16x32_indexed<R: Runtime>(
    client: &ComputeClient<R>,
    dc_grid: Handle,
    coords: Handle,
    dst: Handle,
    ...
    let cubes = n_blocks.div_ceil(TPB).max(1);
    unsafe {
        set_llf_dct16x32_indexed_kernel::launch_unchecked::<R>(
            client,
            CubeCount::Static(cubes, 1, 1),
            CubeDim::new_1d(TPB),
            ArrayArg::from_raw_parts(dc_grid, dc_grid_n),
...
#[allow(clippy::too_many_arguments)]
pub fn set_llf_dct32x32_indexed<R: Runtime>(
    client: &ComputeClient<R>,
    dc_grid: Handle,
    coords: Handle,
    dst: Handle,
    ...
    let cubes = n_blocks.div_ceil(TPB).max(1);
    unsafe {
        set_llf_dct32x32_indexed_kernel::launch_unchecked::<R>(
            client,
            CubeCount::Static(cubes, 1, 1),
            CubeDim::new_1d(TPB),
            ArrayArg::from_raw_parts(dc_grid, dc_grid_n),
